...
(custom-set-faces
 ...
 '(helm-grep-finish ((t (:extend t :foreground "Blue"))))
 '(helm-header ((t (:inherit black))))
 '(helm-lisp-show-completion ((t (:extend t :background "light grey"))))
 '(helm-locate-finish ((t (:extend t :foreground "blue"))))
 '(helm-minibuffer-prompt ((t (:foreground "black" :family "Mono"))))
 '(helm-selection ((t (:extend t :background "light blue" :distant-foreground "light blue"))))
 '(helm-swoop-line-number-face ((t (:foreground "black"))))
 '(hide-ifdef-shadow ((t (:inherit black))))
 '(isearch ((t (:background "blue" :foreground "lightskyblue1"))))
 '(line-number ((t (:foreground "black"))))
 '(mode-line ((t (:background "white" :foreground "black" :inverse-video nil :box (:line-width 1 :color "white") :height 1.0 :family "Hack"))))
 '(mode-line-buffer-id ((t (:inherit sml/filename :background "white" :foreground "blue" :weight bold :height 0.9))))
 '(mode-line-inactive ((t (:background "light gray" :foreground "black" :inverse-video nil))))
 ...
 '(wg-command-face ((t (:foreground "red"))))
 '(wg-current-workgroup-face ((t (:foreground "black"))))
 '(wg-filename-face ((t (:foreground "red"))))
 '(wg-frame-face ((t (:foreground "black"))))
 '(wg-message-face ((t (:foreground "red"))))
 '(wg-mode-line-face ((t (:foreground "red"))))
 '(wg-other-workgroup-face ((t (:foreground " grey"))))
